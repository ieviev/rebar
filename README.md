...
<!-- ./target/release/rebar report --splice README.md /tmp/resharp-results.csv -->
### Summary
...
| Engine | Version | Geometric mean of speed ratios | Benchmark count |
| ------ | ------- | ------------------------------ | --------------- |
| [resharp](benchmarks/../engines/resharp) | 0.3.3 | 1.10 | 28 |
| [rust/regex](benchmarks/../engines/rust/regex) | 1.12.2 | 1.31 | 38 |
...
| [resharp](benchmarks/../engines/resharp) | 0.3.3 | 4.71 | 6 |
...
This report was generated by `rebar 0.1.0 (rev 8e952148cc)`.
...
| - | - | - | - | - | - |
| resharp | 33.2 GB/s | **17.1 GB/s** | **36.8 GB/s** | **10.4 GB/s** | 25.4 GB/s |
| rust/regex | **34.3 GB/s** | 9.6 GB/s | 33.2 GB/s | 7.7 GB/s | **44.1 GB/s** |
...
| Engine | sherlock-en | sherlock-casei-en | sherlock-ru | sherlock-casei-ru | sherlock-zh |
| - | - | - | - | - | - |
| resharp | 12.4 GB/s | **4.9 GB/s** | 3.3 GB/s | 1280.2 MB/s | **16.0 GB/s** |
| rust/regex | **12.6 GB/s** | 2.6 GB/s | **6.0 GB/s** | **1468.4 MB/s** | 14.4 GB/s |
...
| - | - | - | - | - |
| resharp | **197.2 MB/s** | **194.2 MB/s** | 10.84ms | 7.36ms |
| rust/regex | 119.2 MB/s | 117.1 MB/s | **1.67ms** | **6.53ms** |
...
| - | - | - | - |
| rust/regex | **1294.7 MB/s** | **1217.0 MB/s** | **64.95us** |
...
| - | - | - | - |
| rust/regex | **6.4 MB/s** | **287.29us** | **56.8 MB/s** |
...
| - | - | - | - |
| resharp | 443.7 MB/s | **1945.5 MB/s** | 51.7 GB/s |
| rust/regex | **463.8 MB/s** | 1215.9 MB/s | **77.6 GB/s** |
...
| - | - | - | - | - |
| resharp | **95.9 MB/s** | **131.3 MB/s** | 637.4 MB/s | **572.9 MB/s** |
| rust/regex | 91.8 MB/s | 16.8 MB/s | **730.7 MB/s** | 27.4 MB/s |
...
| - | - | - | - | - |
| resharp | - | 1162.7 MB/s | - | 40.31us |
| rust/regex | **1545.0 MB/s** | **1526.8 MB/s** | **91.77us** | **17.49us** |
...
| - | - | - | - | - | - | - |
| resharp | 526.7 MB/s | 518.7 MB/s | **604.0 MB/s** | 655.1 MB/s | 1.36ms | 438.05us |
| rust/regex | **608.5 MB/s** | **587.4 MB/s** | 85.0 MB/s | **765.5 MB/s** | **70.96us** | **71.49us** |
...
| - | - | - | - | - |
| resharp | **646.5 MB/s** | - | 55.18ms | - |
| rust/regex | 639.3 MB/s | **176.1 MB/s** | **10.05ms** | **17.59ms** |
...
| Engine | single | multi | compile-single | compile-multi |
| - | - | - | - | - |
| rust/regex | **87.8 MB/s** | **67.5 MB/s** | **2.54ms** | **3.08ms** |
...
| Engine | 1x | 2x | 10x |
| - | - | - | - |
| resharp | **13.1 MB/s** | 6.6 MB/s | 1346.5 KB/s |
| rust/regex | 12.5 MB/s | **6.9 MB/s** | **1526.6 KB/s** |
