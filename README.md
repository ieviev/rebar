...
| Engine | Version | Geometric mean of speed ratios | Benchmark count |
| ------ | ------- | ------------------------------ | --------------- |
| [resharp](benchmarks/../engines/resharp) | 0.3.4 | 1.11 | 28 |
| [rust/regex](benchmarks/../engines/rust/regex) | 1.12.2 | 1.45 | 38 |
...
| [resharp](benchmarks/../engines/resharp) | 0.3.4 | 6.12 | 6 |
...
This report was generated by `rebar 0.1.0 (rev fda5b7f788)`.
...
| - | - | - | - | - | - |
| resharp | **34.8 GB/s** | **17.1 GB/s** | **40.2 GB/s** | **10.3 GB/s** | 22.4 GB/s |
| rust/regex | 33.7 GB/s | 9.7 GB/s | 33.5 GB/s | 7.7 GB/s | **44.0 GB/s** |
...
| Engine | sherlock-en | sherlock-casei-en | sherlock-ru | sherlock-casei-ru | sherlock-zh |
| - | - | - | - | - | - |
| resharp | 12.2 GB/s | **4.9 GB/s** | 3.3 GB/s | 1248.2 MB/s | **15.9 GB/s** |
| rust/regex | **12.5 GB/s** | 2.5 GB/s | **5.9 GB/s** | **1483.0 MB/s** | 14.8 GB/s |
...
| - | - | - | - | - |
| resharp | **194.2 MB/s** | **192.7 MB/s** | 10.85ms | 7.37ms |
| rust/regex | 119.2 MB/s | 118.7 MB/s | **1.68ms** | **6.46ms** |
...
| - | - | - | - |
| rust/regex | **1296.9 MB/s** | **1227.6 MB/s** | **64.37us** |
...
| - | - | - | - |
| rust/regex | **6.3 MB/s** | **286.85us** | **57.0 MB/s** |
...
| - | - | - | - |
| resharp | **463.8 MB/s** | **1215.9 MB/s** | 44.4 GB/s |
...
| - | - | - | - | - |
| resharp | **96.3 MB/s** | **100.2 MB/s** | 638.2 MB/s | **573.8 MB/s** |
| rust/regex | 92.0 MB/s | 16.6 MB/s | **731.3 MB/s** | 27.8 MB/s |
...
| - | - | - | - | - |
| resharp | - | 1136.3 MB/s | - | 82.53us |
| rust/regex | **1608.3 MB/s** | **1527.5 MB/s** | **91.30us** | **17.23us** |
...
| - | - | - | - | - | - | - |
| resharp | 526.3 MB/s | 520.4 MB/s | **603.5 MB/s** | 655.1 MB/s | 2.15ms | 661.92us |
| rust/regex | **603.0 MB/s** | **586.4 MB/s** | 85.4 MB/s | **766.3 MB/s** | **71.75us** | **72.13us** |
...
| - | - | - | - | - |
| resharp | **646.5 MB/s** | - | 54.20ms | - |
| rust/regex | 639.3 MB/s | **176.0 MB/s** | **10.06ms** | **17.49ms** |
...
| Engine | single | multi | compile-single | compile-multi |
| - | - | - | - | - |
| rust/regex | **87.2 MB/s** | **67.4 MB/s** | **2.55ms** | **3.10ms** |
...
| Engine | 1x | 2x | 10x |
| - | - | - | - |
| resharp | **20.3 MB/s** | **25.1 MB/s** | **24.4 MB/s** |
| rust/regex | 12.5 MB/s | 6.9 MB/s | 1526.2 KB/s |
