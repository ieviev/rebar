...
<!-- ./target/release/rebar report --splice README.md record/curated/2026-09-18/readme.csv -->
### Summary
...
| Engine | Version | Geometric mean of speed ratios | Benchmark count |
| ------ | ------- | ------------------------------ | --------------- |
| [resharp](benchmarks/../engines/resharp) | 0.7.5 | 1.44 | 28 |
| [rust/regex](benchmarks/../engines/rust/regex) | 1.12.2 | 1.61 | 38 |

#### Summary of compile-time benchmarks

| Engine | Version | Geometric mean of speed ratios | Benchmark count |
| ------ | ------- | ------------------------------ | --------------- |
| [rust/regex](benchmarks/../engines/rust/regex) | 1.12.2 | 1.00 | 14 |
| [resharp](benchmarks/../engines/resharp) | 0.7.5 | 6.75 | 6 |
...
This report was generated by `rebar 0.1.0 (rev 90503e69e2)`.
...
| - | - | - | - | - | - |
| resharp | 22.5 GB/s | **13.3 GB/s** | 16.6 GB/s | 2.7 GB/s | 16.2 GB/s |
| rust/regex | **33.4 GB/s** | 9.7 GB/s | **32.8 GB/s** | **7.8 GB/s** | **43.6 GB/s** |
...
| Engine | sherlock-en | sherlock-casei-en | sherlock-ru | sherlock-casei-ru | sherlock-zh |
| - | - | - | - | - | - |
| resharp | 12.1 GB/s | **11.1 GB/s** | 772.1 MB/s | 621.5 MB/s | 3.6 GB/s |
| rust/regex | **12.8 GB/s** | 2.5 GB/s | **6.0 GB/s** | **1497.8 MB/s** | **14.9 GB/s** |
...
| - | - | - | - | - |
| resharp | **184.4 MB/s** | **181.8 MB/s** | 9.94ms | 15.65ms |
| rust/regex | 117.6 MB/s | 116.0 MB/s | **1.66ms** | **6.59ms** |
...
| - | - | - | - |
| rust/regex | **1464.0 MB/s** | **1408.8 MB/s** | **63.15us** |
...
| - | - | - | - |
| rust/regex | **6.2 MB/s** | **288.56us** | **55.5 MB/s** |
...
| - | - | - | - |
| resharp | **1133.8 MB/s** | 1080.8 MB/s | 22.7 GB/s |
| rust/regex | 463.8 MB/s | **1389.6 MB/s** | **84.7 GB/s** |
...
| - | - | - | - | - |
| resharp | **120.6 MB/s** | **181.4 MB/s** | 643.5 MB/s | **517.5 MB/s** |
| rust/regex | 87.2 MB/s | 16.5 MB/s | **732.6 MB/s** | 27.6 MB/s |
...
| - | - | - | - | - |
| resharp | - | 1276.6 MB/s | - | 88.12us |
| rust/regex | **1759.8 MB/s** | **1809.1 MB/s** | **92.75us** | **17.37us** |
...
| - | - | - | - | - | - | - |
| resharp | 503.4 MB/s | 384.3 MB/s | **605.0 MB/s** | **2.3 GB/s** | 1.74ms | 648.89us |
| rust/regex | **603.8 MB/s** | **567.9 MB/s** | 83.8 MB/s | 744.4 MB/s | **72.64us** | **73.29us** |
...
| - | - | - | - | - |
| resharp | **650.6 MB/s** | - | 61.35ms | - |
| rust/regex | 639.5 MB/s | **171.6 MB/s** | **9.89ms** | **17.38ms** |
...
| Engine | single | multi | compile-single | compile-multi |
| - | - | - | - | - |
| rust/regex | **87.6 MB/s** | **71.5 MB/s** | **2.60ms** | **3.16ms** |
...
| Engine | 1x | 2x | 10x |
| - | - | - | - |
| resharp | **33.0 MB/s** | **34.8 MB/s** | **35.5 MB/s** |
| rust/regex | 12.6 MB/s | 6.9 MB/s | 1532.7 KB/s |
